...
echo "export TZ=\"${TZ}\""  >> /var/local/redmine/scripts/env_update_repositories.sh
echo "export REDMINE_API_KEY=\"${REDMINE_API_KEY}\""  >> /var/local/redmine/scripts/env_update_repositories.sh
